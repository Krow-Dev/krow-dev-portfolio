...
const NavBar = () => {
    ...
    return (
        <nav className="bg-custom-gray text-black w-full left-0 z-[101] fixed rounded-b-lg">
                    ...
                    {["Home", "About", "Skills", "Project", "Service", "Contact"].map((section) => (
                        <li key={section}>
                            ...
                            >
                                {section}
                                <span
                                    className="absolute left-0 bottom-0 w-0 h-1 bg-yellow-500 transition-all duration-300 hover:w-full"></span> {/* Underline animation */}
                            </Link>
                        </li>
                    ))}
                </ul>
